...
from .views import RegisterView, LoginView, NormalUserAPI, SuperUserAPI, AnonymousAPI,UserViewSet, NormalAPI, SuperAPI,AnonymousUserAPI, ExternalAPITest, UserServiceAPI, AssignRoleAPI
...
urlpatterns = [
    ...
    path('assign-role/<int:user_id>/', AssignRoleAPI.as_view()),
